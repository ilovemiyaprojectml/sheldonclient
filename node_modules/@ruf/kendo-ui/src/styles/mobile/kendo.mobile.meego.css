...
.km-meego .km-switch-container {
  overflow: hidden;
  border-radius: .8rem;
  background-image: -webkit-gradient(linear, left top, left bottom, from(rgba(0, 0, 0, 0)), color-stop(98%, rgba(0, 0, 0, 0)), to(rgba(0, 0, 0, 0.2)));
  background-image: -webkit-linear-gradient(top, rgba(0, 0, 0, 0), rgba(0, 0, 0, 0) 98%, rgba(0, 0, 0, 0.2));
  background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0), rgba(0, 0, 0, 0) 98%, rgba(0, 0, 0, 0.2));
  padding: 0;
}
...
.km-meego .km-switch-on .km-switch-wrapper {
  background: #1080DD;
  background-image: -webkit-gradient(linear, left top, left bottom, from(rgba(255, 255, 255, 0.2)), color-stop(10%, rgba(255, 255, 255, 0.3)), to(rgba(255, 255, 255, 0)));
  background-image: -webkit-linear-gradient(top, rgba(255, 255, 255, 0.2), rgba(255, 255, 255, 0.3) 10%, rgba(255, 255, 255, 0));
  background-image: linear-gradient(to bottom, rgba(255, 255, 255, 0.2), rgba(255, 255, 255, 0.3) 10%, rgba(255, 255, 255, 0));
}
.km-meego .km-badge,
.km-meego .km-detail {
...
.km-meego .k-slider .k-draghandle:hover {
  ...
  -webkit-box-shadow: inset 0 0 0 1px #ddd, 0 1px 1px rgba(0,0,0,.3);
...
.km-meego .k-slider-selection {
  ...
  background-image: -webkit-gradient(linear, left top, left bottom, from(#6da9f7), to(#2a5db2));
  background-image: -webkit-linear-gradient(top, #6da9f7, #2a5db2);
  background-image: linear-gradient(to bottom, #6da9f7, #2a5db2);
}
