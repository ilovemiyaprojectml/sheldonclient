...
@fiori-background: #f3f8fc;
@fiori-text: #333;

/*switch, popover, modalview*/
@fiori-secondary-background: #fff;
@fiori-overlay-background: rgba(64,70,75,.6);

/*navbar*/
@fiori-secondary-text: #666;

/*buttons*/
@fiori-button-border: #bfbfbf;
@fiori-button-background: #f2f2f2;
@fiori-button-primary-background: #009de0;
@fiori-button-selected-background: #007cc0;
@fiori-button-selected-border: #005483;
@fiori-button-hover-background: #eaeaea;

/*actionsheet, popover and modalview buttons*/
@fiori-inverse-background: #40464b;
@fiori-inverse-hover-background: #4c5358;
@fiori-inverse-text: #fff; /*also listview and button selected text*/
@fiori-inverse-border: #7b7b7c;

@switch-color: @fiori-inverse-text;

@fiori-shadow: rgba(0,0,0,.2);

/*listview*/
@fiori-list-background: #fafafa;
@fiori-list-hover-background: #f0f0f0; /*also modalview title*/
@fiori-list-selected-background: #e6f2f9;
@fiori-list-group-background: #f7f7f7;
@fiori-list-group-text: #004990;
@fiori-list-border: #ddd;

@accent: #f44336;

.km-fiori
{
    background-color: @fiori-background;
}
...
{
    background: @fiori-inverse-background;
    color: @fiori-inverse-text;
}
...
{
    background: @fiori-inverse-hover-background;
}

.km-fiori .km-footer .km-tabstrip .km-button,
.km-fiori .km-actionsheet > li > a
{
    border-color: @fiori-inverse-border;
}

.km-fiori .km-actionsheet > .km-actionsheet-cancel > a
{
    background: @fiori-button-primary-background;
}
...
.km-fiori .km-button
{
    background: @fiori-button-background;
    border-color: @fiori-button-border;
}

.km-fiori .km-button:hover
{
    background: @fiori-button-hover-background;
}

.km-fiori .km-button.km-state-active
{
    background: @fiori-button-selected-background;
}
...
{
    background: @fiori-secondary-background;
}
...
.km-fiori .km-list > li
{
    background: @fiori-list-background;
    border-color: @fiori-button-border;
}
...
{
    background-color: @fiori-list-hover-background;
}
...
{
    background: #f7f7f7;
    border-color: @fiori-list-border transparent #a4bdd4;
    color: @fiori-list-group-text;
}
...
{
    background: @fiori-button-border;
}
...
.km-fiori .km-popup
{
    background: @fiori-overlay-background;
}
...
.km-fiori .km-switch-background
{
    color: @fiori-button-selected-background;
}
...
.km-fiori .km-filter-wrap > input:focus
{
    border-color: @fiori-button-selected-background;
}
...
.km-fiori .km-label-above {
    color: darken(@fiori-button-border, 27%);
}
...
.km-fiori .km-checkbox:checked + .km-checkbox-label:after {
    background-color: @fiori-button-selected-background;
}
