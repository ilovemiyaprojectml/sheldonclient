...
@fiori-border-width: 1px;
@fiori-border-radius: 2px;
@fiori-inline-border-radius: (@fiori-border-radius - 1px);
...
.km-fiori .km-actionsheet > li > a
{
    ...
    padding: .5em .6em;
    border-radius: 0;
    border-width: 0 0 @fiori-border-width;
    border-style: solid;
    .box-sizing(border-box);
}
...
{
    bottom: 0;
    border-width: @fiori-border-width 0 0;
    border-style: solid;
    border-radius: 0;
    .box-sizing(border-box);
}
...
{
    border-radius: @fiori-border-radius;
}
...
.km-fiori .km-scroller-refresh .km-loading-right
{
    ...
    margin-top: -.5em;
    border-radius: 1em;
    .animation(km-fioriload .6s infinite linear);
...
.km-fiori .km-scroller-refresh .km-loading-right
{
    ...
    margin-left: -.6em;
    width: .25em;
    .animation(km-fiorirefresh .6s infinite linear);
}
