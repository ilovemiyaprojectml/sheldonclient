...
.km-android .km-rowdelete {
  background-image: -webkit-gradient(linear, left top, left bottom, from(rgba(68, 68, 68, 0.5)), color-stop(50%, rgba(204, 204, 204, 0.5)), color-stop(50%, rgba(68, 68, 68, 0.1)), to(rgba(68, 68, 68, 0)));
  background-image: -webkit-linear-gradient(top, rgba(68, 68, 68, 0.5), rgba(204, 204, 204, 0.5) 50%, rgba(68, 68, 68, 0.1) 50%, rgba(68, 68, 68, 0));
  background-image: linear-gradient(to bottom, rgba(68, 68, 68, 0.5), rgba(204, 204, 204, 0.5) 50%, rgba(68, 68, 68, 0.1) 50%, rgba(68, 68, 68, 0));
  border-color: #444;
...
.km-android .km-navbar [class*=item] .km-text,
.km-android .km-tabstrip .km-text {
  border-right-color: rgba(238, 238, 238, 0.265);
}
.km-android .km-navbar [class*=item] .km-text {
...
.km-android .km-list > li {
  -webkit-box-shadow: 0 1px 1px rgba(68, 68, 68, 0.135);
  box-shadow: 0 -1px 0 rgba(68, 68, 68, 0.135);
}
...
.km-android .km-group-title {
  ...
  -webkit-box-shadow: inset 0 -1px 1px rgba(68, 68, 68, 0.3);
  box-shadow: inset 0 -1px 0 rgba(68, 68, 68, 0.3);
}
...
.km-android .km-loading {
  border-color: #444 rgba(68, 68, 68, 0.2);
  -webkit-box-shadow: 0 1px 0 rgba(238, 238, 238, 0.1), 0 -1px 0 rgba(238, 238, 238, 0.1), inset 0 1px 0 rgba(238, 238, 238, 0.1), inset 0 -1px 0 rgba(238, 238, 238, 0.1);
          box-shadow: 0 1px 0 rgba(238, 238, 238, 0.1), 0 -1px 0 rgba(238, 238, 238, 0.1), inset 0 1px 0 rgba(238, 238, 238, 0.1), inset 0 -1px 0 rgba(238, 238, 238, 0.1);
}
...
/* ModalView */
.km-android .km-modalview {
  -webkit-box-shadow: 0 0 10px rgba(102, 102, 102, 0.5) 0 0 2px rgba(68, 68, 68, 0.7);
          box-shadow: 0 0 10px rgba(102, 102, 102, 0.5) 0 0 2px rgba(68, 68, 68, 0.7);
  border-color: #eee;
}
.km-android .km-modalview .km-view-title {
  -webkit-box-shadow: inset 0 -2px rgba(68, 68, 68, 0.1);
          box-shadow: inset 0 -2px rgba(68, 68, 68, 0.1);
}
...
.km-android .km-listview-label input[type=checkbox]:checked:after {
  text-shadow: 0 1px 1px rgba(238, 238, 238, 0.2);
}
...
.km-android-dark .km-list fieldset legend {
  -webkit-box-shadow: 0 2px 0 0 rgba(68, 68, 68, 0.4);
  box-shadow: 0 2px 0 0 rgba(68, 68, 68, 0.4);
}
