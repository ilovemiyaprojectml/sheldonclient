...
.km-state-active .km-detail {
  -webkit-box-shadow: inset 0 0 0 1000px rgba(27, 20, 26, 0.2);
          box-shadow: inset 0 0 0 1000px rgba(27, 20, 26, 0.2);
}
/* Switch */
.km-switch-wrapper {
...
.km-switch-background {
  ...
  background-image: url(textures/glass-lighter.png), -webkit-gradient(linear, left top, left bottom, from(#bababa), to(#bababa));
  background-image: url(textures/glass-lighter.png), -webkit-linear-gradient(top, #bababa, #bababa);
  background-image: url(textures/glass-lighter.png), linear-gradient(to bottom, #bababa, #bababa);
...
.km-list > li {
  background: #0c090c;
  border-color: rgba(255, 255, 255, 0.2);
  -webkit-box-shadow: inset 0 1px 0 rgba(27, 20, 26, 0.2);
          box-shadow: inset 0 1px 0 rgba(27, 20, 26, 0.2);
}
.km-listinset > li:first-child,
.km-listgroupinset .km-list > li:first-child {
  border-color: rgba(255, 255, 255, 0.2);
...
.km-widget.km-actionsheet > li > a {
  background: #333333;
  border-bottom-color: rgba(27, 20, 26, 0.2);
}
...
.km-popup .k-list-container {
  background: rgba(0, 0, 0, 0.4);
  border-top-color: rgba(27, 20, 26, 0.2);
}
/* PopOver */
.km-popup.km-pane {
  border-color: #333333;
