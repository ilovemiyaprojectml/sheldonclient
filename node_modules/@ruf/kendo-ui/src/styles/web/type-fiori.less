...
@widget-border-color: darken(@background, 25%);
@widget-gradient: none;
@widget-shadow: none;
// Button
@button-text-color: @normal-text-color;
@button-background-color: darken(@background, 5%);
@button-border-color: darken(@background, 25%);
@button-gradient: false;
@button-shadow: false;
@button-hover-text-color: @normal-text-color;
@button-hover-background-color: @hover-background;
@button-hover-border-color: darken(@background, 25%);
...
@button-active-border-color: darken(@accent, 12%);
...
@primary-background-color: lighten(@accent, 9%);
@primary-border-color: lighten(@accent, 4%);
...
@primary-hover-border-color: lighten(@accent, 4%);
@primary-hover-gradient: false;
@primary-hover-shadow: false;
@primary-active-text-color: @background;
@primary-active-background-color: darken(@accent, 2%);
@primary-active-border-color: darken(@accent, 2%);
@primary-active-gradient: false;
@primary-active-shadow: false;
@primary-focused-border-color: darken(@accent, 12%);
@primary-focused-shadow: false;
@primary-focused-active-shadow: false;
@primary-disabled-text-color: @background;
@primary-disabled-background-color: darken(@info, 15%);
@primary-disabled-border-color: darken(@info, 17%);
...
@header-background-color: darken(@background, 5%);
...
@hover-shadow: none;
@select-background-color: @accent;
@select-border-color: @accent;
@select-hover-background-color: @background;
@select-group-background-color: @background;
@selected-background-color: @accent;
@selected-secondary-background-color: lighten(@info, 4%);
...
@active-border-color: darken(@background, 21%);
@active-shadow: none;
@error-text-color: lighten(@normal-text-color, 20%);
@error-background-color: @error;
@error-border-color: lighten(@normal-text-color, 20%);
@disabled-text-color: lighten(@normal-text-color, 29%);
@notification-info-background-color: @info;
@notification-info-text-color: @normal-text-color;
@notification-info-border-color: @accent;
@notification-success-background-color: @success;
@notification-success-text-color: @normal-text-color;
@notification-success-border-color: darken(@success, 40%);
@notification-warning-background-color: @warning;
@notification-warning-text-color: @normal-text-color;
@notification-warning-border-color: darken(@warning, 35%);
@notification-error-background-color: @error;
@notification-error-text-color: @normal-text-color;
@notification-error-border-color: darken(@error, 20%);
@notification-gradient: false;
@tooltip-text-color: @normal-text-color;
@tooltip-background-color: @background;
@tooltip-border-color: darken(@background, 25%);
...
@splitbar-background-color: darken(@background, 5%);
@draghandle-border-radius: @border-radius;
@draghandle-border-color: lighten(@normal-text-color, 24%);
@draghandle-background-color: darken(@background, 5%);
@draghandle-shadow: none;
@draghandle-hover-border-color: lighten(@normal-text-color, 24%);
@draghandle-hover-background-color: lighten(@normal-text-color, 27%);
...
@column-highlight-background-color: darken(@hover-background, 2%);
@active-filter-background-color: @background;
@scheduler-background-color: darken(@background, 5%);
@current-time-color: lighten(@normal-text-color, 20%);
@event-background-color: @accent;
@event-text-color: @background;
@event-inverse-text-color: @normal-text-color;
@scheduler-nonwork-background-color: darken(@hover-background, 2%);
@resize-background-color: @background;
@upload-progress-background-color: darken(@info, 50%);
@upload-progress-text-color: darken(@info, 50%);
@upload-success-background-color: darken(@success, 40%);
@upload-success-text-color: darken(@success, 40%);
@upload-error-background-color: @error;
@upload-error-text-color: darken(@error, 50%);
@task-summary-color: darken(@background, 20%);
@task-summary-selected-color: lighten(@info, 4%);
...
@drop-down-border-color: darken(@background, 25%);
@drop-down-hover-border-color: @accent;
@drop-down-focused-border-color: @accent;
...
@numeric-selected-background: @hover-background;
@panelbar-items-border: darken(@background, 25%);
@panelbar-content-background: @background;
@panelbar-content-color: @normal-text-color;
@window-shadow-style: 1px 1px 13px 1px;
@filter-menu-content-background: @background;
@icon-background-color: transparent;
@disabled-background-color: darken(@background, 25%);
@disabled-border-color: darken(@background, 5%);
...
.k-scheduler-monthview .k-today {
    background: @column-highlight-background-color;
}
...
.k-menu {
    .k-state-selected > .k-link {
        color: @widget-text-color;
        background-color: @selected-secondary-background-color;
    }
...
.k-listview > .k-state-selected {
    color: @widget-text-color;
    background-color: desaturate(@selected-secondary-background-color, 5%);
}
...
.k-multiple-files-extension-wrapper:before {
    background-color: @widget-background-color;
    border-color: transparent transparent @disabled-background-color @disabled-background-color;
}
...
.k-multiple-files-extension-wrapper:after {
    border-top-color: @disabled-background-color;
    border-left-color: @disabled-background-color;
}
...
@checkbox-border-color: darken(@background, 25%);
@checkbox-border-radius: 1px;
@checkbox-hover-border-color: @accent;
@checkbox-checked-border-color: darken(@background, 25%);
@checkbox-active-border-color: @accent;
@checkbox-active-box-shadow: none;
@checkbox-disabled-background-color: lighten(@hover-background, 4%);
@checkbox-disabled-color: darken(@background, 27%);
@checkbox-disabled-border-color: darken(@background, 25%);

@import "themes/radiobutton.less";

@radio-border-color: darken(@background, 25%);
@radio-border-width: 2px;
@radio-hover-border-color: @accent;
@radio-active-border-color: darken(@background, 25%);
@radio-active-box-shadow: none;
@radio-disabled-color: darken(@background, 25%);
...
.k-grid tr.k-state-selected:hover td {
    background-color: darken(@selected-secondary-background-color, 3%);
}
...
.k-state-selected .k-task-summary-complete
{
    ...
    background: @primary-active-background-color;
}
...
.k-calendar {
    ...
    .k-today.k-state-hover {
        background-color: spin(@accent, -3);
    }

    .k-today.k-state-focused,
    .k-today:active,
    .k-today.k-state-selected:active {
        box-shadow: inset 0 0 0px 1px darken(@accent, 12%);
    }
    ...
    td.k-state-selected.k-state-hover {
        background-color: screen(@accent, #cfcfcf);
    }
...
@media only screen and (max-width: 1024px) {
    ...
    .k-safari {
        ...
        .k-scheduler-toolbar > ul.k-scheduler-views.k-state-expanded {
            border-width: 1px 1px 0 1px;
            border-style: solid;
            border-color: transparent; /*@secondary-border-color*/
            background-color: @header-background-color;
            border-radius: 0;
            border-width: 1px;
            background-image: none;
        ...
        .k-rtl .k-pager-numbers:first-child,
        ...
        .k-pager-wrap .k-pager-numbers .k-current-page .k-link {
            ...
            line-height: 1.571em;
            height: 1.571em;
            padding: 0.5em .429em 0.5em 0.8em;
            border-radius: @border-radius;
            .composite-background(@widget-gradient);
            background-position: 50% 50%;
            background-color: @drop-down-background;
