...
.k-checkbox-label:before {
  font: 18px "WebComponentsIcons", monospace;
  content: "";
  position: absolute;
  top: 0;
  left: 0;
...
.k-treeview .k-checkbox-label {
  padding-left: -webkit-calc(18px + 0.7ex);
  padding-left: calc(18px + 0.7ex);
}
.k-treeview .k-icon,
.k-treeview .k-in {
  vertical-align: middle;
...
.k-spreadsheet .k-tabstrip-items .k-link.k-spreadsheet-sheets-remove {
  padding: 0;
  margin-left: .4em;
}
