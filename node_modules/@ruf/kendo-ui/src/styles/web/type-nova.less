...
@button-active-background: @selected-background;
...
@primary-hover-background-color: @accent-hover-background;
@primary-hover-border-color: @accent-hover-background;
...
@primary-focused-border-color: @accent-hover-background;
...
@accent-hover-background: multiply(@accent, #e4e4e4);
...
.k-multiselect-wrap,
.k-multiselect-wrap.k-state-hover:hover {
    background-color: @widget-background-color;
    border-color: darken(@normal-background, 12%);
}
...
.k-calendar {
    ...
    .k-state-disabled .k-link{
        color: lighten(@hover-text-color, 23%);
    }
...
@media only screen and (max-width: 1024px) {
    ...
    .k-safari {
        ...
        .k-gantt-toolbar > ul.k-gantt-views > li.k-current-view:hover,
        ...
        .k-gantt-toolbar > ul.k-gantt-views.k-state-expanded > .k-state-hover,
        .k-scheduler-toolbar > ul.k-scheduler-views.k-state-expanded > .k-state-hover {
            background-color: @hover-background;
        }

        .k-gantt-toolbar > ul.k-gantt-views.k-state-expanded >.k-state-selected,
        .k-scheduler-toolbar > ul.k-scheduler-views.k-state-expanded >.k-state-selected {
            color: @selected-text-color;
            background-color: @selected-background;
        }

        .k-gantt-toolbar > ul.k-gantt-views.k-state-expanded >.k-state-hover .k-link,
        .k-scheduler-toolbar > ul.k-scheduler-views.k-state-expanded >.k-state-hover .k-link {
            background-color: transparent;
        }

        .k-gantt-toolbar > ul.k-gantt-views.k-state-expanded > li.k-current-view .k-link,
        .k-scheduler-toolbar > ul.k-scheduler-views.k-state-expanded > li.k-current-view .k-link {
            color: @inversed-text-color;
        }
        ...
        .k-gantt-toolbar > ul.k-gantt-views.k-state-expanded .k-link,
        .k-scheduler-toolbar > ul.k-scheduler-views.k-state-expanded .k-link {
            color: @link-text-color;
        }

        .k-gantt-toolbar > ul.k-gantt-views.k-state-expanded .k-state-selected .k-link,
        .k-scheduler-toolbar > ul.k-scheduler-views.k-state-expanded .k-state-selected .k-link {
            color: @selected-text-color;
        }
        ...
        .k-grid .k-pager-numbers {
            ...
            height: auto;
            background-color: @normal-background;
            border: 1px solid darken(@normal-background, 12%);
            border-radius: 3px;
        }
        ...
        .k-grid .k-pager-numbers.k-state-expanded {
...
@spreadsheet-selection-border: #26c6da;
@spreadsheet-selection-background: fadeout(@spreadsheet-selection-border, 80%);

@active-header-text: contrast(@accent);
@inactive-header-text: contrast(@accent);
...
.k-spreadsheet {
    ...
    .k-spreadsheet-sheets-bar {
        .k-button {
            ...
            border-radius: 0;
            line-height: 2.6em;
            height: calc(3.1em + 2px); // IE centering icon fix
            width: 3em;

            &:hover {
                .composite-background(@tabs-hover-gradient);
                border-color: saturate(@normal-text-color, 7%);
            }
        }
    }
...
.k-grid-header {
    .k-i-sort-asc-sm,
    .k-i-sort-desc-sm,
    .k-i-sort-asc-sm:hover,
    .k-i-sort-desc-sm:hover,
    .k-sort-order {
        color: @accent;
        opacity: 1;
        margin-bottom: -1px;
