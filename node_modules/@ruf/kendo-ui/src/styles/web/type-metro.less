...
@button-border-color: contrast(@base, lighten(@base, 14%), darken(@base, 14%), 0.5);
...
@button-focused-border-color: contrast(@base, lighten(@accent, 14%), darken(@accent, 14%), 0.5);
...
@primary-active-background-color: @accent;
@primary-active-border-color: @accent;
@primary-active-gradient: false;
@primary-active-shadow: false;
@primary-focused-border-color: contrast(@base, lighten(@accent, 16%), darken(@accent, 29%), 0.5);
...
@notification-info-text-color: contrast(@base, lighten(@normal-text-color, 1%), darken(@normal-text-color, 7%), 0.5);
@notification-info-border-color: contrast(@base, lighten(@info, 1%), darken(@info, 11%), 0.5);
@notification-success-background-color: @success;
@notification-success-text-color: contrast(@base, lighten(@normal-text-color, 1%), darken(@normal-text-color, 3%), 0.5);
@notification-success-border-color: contrast(@base, lighten(@success, 1%), darken(@success, 11%), 0.5);
@notification-warning-background-color: @warning;
@notification-warning-text-color: contrast(@base, lighten(@normal-text-color, 1%), darken(@normal-text-color, 7%), 0.5);
@notification-warning-border-color: darken(@warning, 15%);
@notification-error-background-color: contrast(@base, lighten(@error, 15%), darken(@error, 9%), 0.5);
@notification-error-text-color: saturate(@normal-text-color, 12%);
@notification-error-border-color: contrast(@base, lighten(@error, 15%), darken(@error, 20%), 0.5);
@notification-gradient: false;
@tooltip-background-color: lighten(@hover-background, 1%);
...
@event-inverse-text-color: darken(@success, 29%);
...
@tooltip-border-color: lighten(@hover-background, 1%);
...
@calendar-footer-hover-background: @base;
@calendar-header-hover-text-decoration: none;
@calendar-header-hover-background: @hover-background;
@calendar-footer-active-background: @base;
@calendar-group-background-color: @base;
...
.k-calendar {
    ...
    .k-today {
        box-shadow: inset 0 0 0 1px @hover-background-color;
    }
    ...
    td.k-state-hover.k-state-focused {
        box-shadow: inset 0 0 0 1px contrast(@base, darken(@hover-background, 10%), lighten(@hover-background, 86%), 0.5);
    }
...
@checkbox-border-color: contrast(@base, lighten(@base, 28%), darken(@base, 14%), 0.5);
@checkbox-border-radius: 0;
@checkbox-background-color: @base;
@checkbox-hover-border-color: @hover-background;
@checkbox-checked-border-color: contrast(@base, lighten(@base, 28%), darken(@base, 14%), 0.5);
@checkbox-checked-background-color: @base;
@checkbox-checked-color: @hover-background;
@checkbox-active-border-color: @hover-background;
@checkbox-active-box-shadow: none;
@checkbox-disabled-background-color: @base;
@checkbox-disabled-color: contrast(@base, lighten(@base, 30%), darken(@base, 30%), 0.5);
@checkbox-disabled-border-color: contrast(@base, lighten(@base, 10%), darken(@base, 10%), 0.5);

@import "themes/radiobutton.less";

@radio-border-color: contrast(@base, lighten(@base, 28%), darken(@base, 14%), 0.5);
@radio-hover-border-color: @hover-background;
@radio-checked-background-color: @hover-background;
@radio-active-border-color: @hover-background;
@radio-active-box-shadow: none;
@radio-disabled-color: contrast(@base, lighten(@base, 30%), darken(@base, 30%), 0.5);
@radio-disabled-border-color: contrast(@base, lighten(@base, 10%), darken(@base, 10%), 0.5);
