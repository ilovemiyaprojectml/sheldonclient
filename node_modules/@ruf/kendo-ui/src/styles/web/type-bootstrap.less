...
@button-focused-active-shadow: @button-focused-shadow, @button-active-shadow;
// Primary button
...
@primary-focused-shadow: 0 0 8px 0 darken(@info, 6%);
...
@tooltip-background-color: contrast(@base);
@tooltip-border-color: contrast(@base);
...
@upload-success-background-color: darken(@success, 50%);
@upload-success-text-color: darken(@success, 50%);
@upload-error-background-color: darken(@error, 50%);
...
.k-calendar {
    ...
    .k-state-focused.k-state-hover {
        background-color: lighten(@selected-background-color, 37%);
    }

    .k-state-selected.k-state-hover {
        background-color: darken(@selected-background, 8%);
    }
    ...
    td.k-state-focused.k-state-selected.k-state-hover {
        box-shadow: inset 0 0 7px 0 darken(@selected-background, 25%);
    }
    ...
    .k-today.k-state-focused.k-state-hover {
        background-color: lighten(@selected-background-color, 37%);
    }

    .k-today.k-state-selected.k-state-hover {
        background-color: darken(@selected-background, 8%);
    }
...
.k-popup .k-list .k-state-focused {
    ...
    box-shadow: inset 0 0 2px 0 @accent, @focused-item-shadow;
}
...
.km-pane-wrapper .km-pane .k-mobile-list.k-filter-menu {
    .k-space-right {
        ...
        > input:focus {
            border-color: lighten(@accent, 13%);
...
.k-toolbar:not(.k-spreadsheet-toolbar) {
...
.k-grid tr.k-state-selected:hover td.k-state-focused {
    box-shadow: inset 0 0 7px 0 darken(@accent, 30%);
}
...
.k-menu {
    ...
    .k-state-hover .k-link.k-state-active {
        background-color: darken(@hover-background-color, 7%);
    }
}
...
.k-spreadsheet {
    .k-widget {
        &[data-property='fontSize'] { width: 70px; }
...
.k-dialog {
    ...
    .k-dialog-buttongroup {
        ...
        &.k-dialog-button-layout-normal {
            border-top: 1px solid @button-hover-background-color;
            border-radius: @border-radius;
