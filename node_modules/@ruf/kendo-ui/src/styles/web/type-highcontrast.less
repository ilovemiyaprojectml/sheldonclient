...
@button-focused-border-color: lighten(@background, 26%);
@button-focused-shadow: inset 0 0 3px 1px #fff;
@button-focused-active-shadow: inset 0 0 3px 1px #fff;
// Primary button
@primary-text-color: @normal-text-color;
@primary-background-color: darken(@hover-background, 6%);
@primary-border-color: desaturate(@hover-background, 2%);
@primary-gradient: @selected-gradient;
@primary-shadow: false;
@primary-hover-text-color: @normal-text-color;
@primary-hover-background-color: desaturate(@hover-background, 2%);
@primary-hover-border-color: desaturate(@hover-background, 2%);
@primary-hover-gradient: @hover-gradient;
@primary-hover-shadow: false;
@primary-active-text-color: @normal-text-color;
@primary-active-background-color: darken(@hover-background, 6%);
@primary-active-border-color: desaturate(@hover-background, 2%);
@primary-active-gradient: @selected-gradient;
@primary-active-shadow: false;
@primary-focused-border-color: @normal-text-color;
@primary-focused-shadow: 0 0 3px 0 #fff;
@primary-focused-active-shadow: @primary-focused-shadow;
@primary-disabled-text-color: darken(@normal-text-color, 29%);
@primary-disabled-background-color: darken(@hover-background, 6%);
@primary-disabled-border-color: desaturate(@hover-background, 2%);
...
@select-border-color: lighten(@background, 26%);
...
@focused-border-color: @normal-text-color;
@focused-shadow: 0 0 3px 0 @shadow-color;
@focused-item-shadow: inset 0 0 3px 1px #fff;
@focused-active-item-shadow: inset 0 0 3px 1px #fff;
@active-background-color: @base;
@active-border-color: @hover-background;
@active-text-color: @normal-text-color;
@error-background-color: lighten(@accent, 7%);
@error-border-color: lighten(@accent, 7%);
@error-text-color: @normal-text-color;
@disabled-text-color: darken(@normal-text-color, 50%);
...
@tooltip-background-color: @base;
@tooltip-border-color: darken(@normal-text-color, 21%);
...
@draghandle-background-color: @button-background-color;
@draghandle-shadow: none;
@draghandle-hover-border-color: @button-hover-border-color;
@draghandle-hover-background-color: @button-hover-background-color;
@draghandle-hover-shadow: none;
@alt-background-color: @base;
@nested-alt-background-color: lighten(@alt-background-color, 8%);
@active-filter-background-color: @hover-background;
@cell-border-color: lighten(@background, 26%);
@column-highlight-background-color: lighten(@background, 15%);
@scheduler-background-color: @background;
@event-text-color: darken(@accent, 27%);
@event-inverse-text-color: @normal-text-color;
@current-time-color: lighten(@accent, 7%);
@event-background-color: darken(@normal-text-color, 6%);
@scheduler-nonwork-background-color: lighten(@base, 13%);
@resize-background-color: @normal-text-color;
@shadow-color: rgba(0, 0, 0, 0.7);
@shadow-inset-color: darken(@base, 9%);
@link-text-color: @normal-text-color;
@upload-progress-background-color: @normal-text-color;
@upload-progress-text-color: @normal-text-color;
@upload-success-background-color: @success;
@upload-success-text-color: @normal-text-color;
@upload-error-background-color: @error;
@upload-error-text-color: @normal-text-color;
@task-summary-color: darken(@widget-text-color, 25%);
@task-summary-selected-color: darken(@selected-background-color, 25%);
@loading-panel-color: @base;
@splitbar-background-color: @base;
...
@menu-border-color: lighten(@background, 26%);
@tabstrip-items-border: lighten(@background, 26%);
@tabstrip-active-background: @base;
@tabstrip-tabs-color: @normal-text-color;
@form-widget-color: @normal-text-color;
@drop-down-border-color: lighten(@background, 26%);
@drop-down-hover-border-color: lighten(@background, 26%);
@drop-down-focused-border-color: lighten(@background, 26%);
@drop-down-background: @base;
@drop-down-text-color: @normal-text-color;
@secondary-border-color: lighten(@background, 26%);
@secondary-text-color: @normal-text-color;
@numeric-selected-background: @accent;
@panelbar-items-border: lighten(@background, 26%);
...
@disabled-border-color: lighten(@background, 26%);
...
.k-calendar {
    ...
    .k-today.k-state-hover .k-link,
    .k-today.k-state-focused .k-link,
    .k-today.k-state-selected .k-link {
        box-shadow: none;
    }
...
.k-multiple-files-extension-wrapper:before {
    background-color: @active-background-color;
    border-color: transparent transparent @header-text-color @header-text-color;
}
...
.k-multiple-files-extension-wrapper:after {
    ...
    border-left-color: @header-text-color;
}
...
.k-grid tr.k-state-selected:hover td {
    background-color: lighten(@hover-background, 7%);
}
...
@checkbox-border-color: @normal-text-color;
...
@checkbox-active-box-shadow: 0 0 3px 0 #fff;
...
@radio-border-color: @normal-text-color;
@radio-background-color: @normal-background;
@radio-hover-border-color: @normal-text-color;
@radio-hover-box-shadow: 0 0 0 1px @normal-text-color;
@radio-checked-background-color: @normal-text-color;
@radio-active-border-color: @normal-text-color;
@radio-active-box-shadow: 0 0 3px 0 @normal-text-color;
@radio-disabled-background-color: @normal-background;
@radio-disabled-color: @disabled-text-color;
@radio-disabled-border-color: #634b5f;
...
@media only screen and (max-width: 1024px) {
    ...
    .k-safari {
        ...
        .km-pane-wrapper .k-pager-numbers.k-state-expanded,
...
@spreadsheet-page-orientation-background: @content-background-color;
