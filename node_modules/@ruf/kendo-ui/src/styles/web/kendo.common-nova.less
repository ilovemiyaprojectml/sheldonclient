...
*/
@line-height: (20/14);
@line-height-em: ((20/14)*1em);
@input-height: 2.214285714em;
...
.k-split-button-arrow {
    display: inline-flex; // TODO improve elastic behavior
    height: ~"calc(@{line-height-em} + (2*@{button-padding-y}) + 2px)"; // ensure inline-flex height
    width: ~"calc(@{line-height-em} + (2*@{button-padding-y}) + 2px)";
}
...
.k-colorpicker {
    ...
    .k-selected-color {
        @selected-icon-height: 2.57142857em;
