...
@calendar-cell-width: ((54px / 14px) * 1em);
...
.k-ie {
    ...
    input.k-textbox {
        height: ~"calc(@{input-height} + @{input-padding-y}*2 + 2px)";
    }
}
...
.k-button-icon {
    height: ~"calc(1.72em + (2*@{button-padding-y}) + 2px)"; // ensure inline-flex height
...
.k-multiselect-wrap li {
    min-height: calc((@input-height - .15em) + 0.64285714em + 2px);
    margin: 0.2143em 0 0.2143em 0.2143em;
    padding: 0.32142857em 1.8em 0.32142857em .857em;
}
...
{
    padding-top: 0;
    line-height: calc((@input-height - .15em) + 0.64285714em);
}
...
.k-numerictextbox .k-link {
    display: block;
    height: ~"calc((@{input-height} / 2) + @{input-padding-y})";
}
...
.k-colorpicker
{
    ...
    .k-selected-color {
        @selected-icon-height: ~"calc(@{input-height} + @{input-padding-y}*2)";
...
.k-rtl .k-scheduler-toolbar .k-nav-today .k-link
{
    padding-right: 0;
    padding-left: 1.1em;
}
