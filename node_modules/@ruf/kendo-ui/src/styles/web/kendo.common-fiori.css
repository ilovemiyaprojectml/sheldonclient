...
.k-button-icon {
  height: -webkit-calc(2.72em + 2px);
  height: calc(2.72em + 2px);
}
...
.k-button-icon,
.k-split-button-arrow {
  width: -webkit-calc(2.72em + 2px);
  width: calc(2.72em + 2px);
  padding: 0.5em 7px;
}
...
.k-ie input.k-textbox {
  height: -webkit-calc(2.714285714em + 2px);
...
.k-combobox-clearable .k-input {
  ...
  width: -webkit-calc(100% - 2.71428571em);
...
.k-multiselect-wrap li {
  min-height: -webkit-calc(2.14285714em + 2px);
...
.k-spreadsheet .k-spreadsheet-sheets-bar .k-tabstrip-items .k-item {
  background-color: transparent;
}
.k-spreadsheet .k-spreadsheet-sheets-bar .k-link {
  padding-bottom: .75em;
}
