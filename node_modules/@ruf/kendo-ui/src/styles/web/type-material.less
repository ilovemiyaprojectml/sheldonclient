...
.k-button-group {
    ...
    .k-button {
        ...
        &.k-state-disabled,
        .k-state-disabled&,
        &.k-state-disabled.k-state-active,
        .k-state-disabled&.k-state-active {
            color: @disabled-text-color;
...
@checkbox-border-color: lighten(@normal-text-color, 23%);
...
@radio-border-color: lighten(@normal-text-color, 23%);
@radio-border-width: 2px;
@radio-hover-border-color: @radio-border-color;
@radio-checked-background-color: @accent;
@radio-disabled-background-color: lighten(@background, 20%);
@radio-disabled-color: contrast(@background, lighten(@background, 20%), darken(@background, 25%), 0.5);
@radio-disabled-border-color: #bfbfbf;

.k-radio:checked + .k-radio-label:before,
.k-radio:checked + .k-radio-label:hover:before {
    border-color: @radio-checked-background-color;
}
...
.k-calendar .k-header .k-state-hover {
    background-color: @secondary-header-background-color;
}
...
.k-calendar .k-today.k-state-hover {
    background-color: contrast(@background, darken(@accent, 10%), softlight(@accent, #b9b9b9), .5);
}

.k-calendar .k-today:active {
    box-shadow: inset 0 0 0 1px contrast(@background, darken(@accent, 15%), softlight(@accent, #b9b9b9), .5);
}
...
.k-pivot-toolbar .k-button {
    color: @header-text-color;
    background-color: @secondary-header-background-color;
    border-color: @secondary-header-background-color;
    .box-shadow(none);
}
...
.k-grid tr.k-state-selected > td {
    border-color: darken(@selected-background, 10%);
}
...
.k-task-complete
{
    background: @selected-background 0 -257px @tooltip-texture repeat-x;
}
...
{
    .box-shadow(none);
    border-color: @draghandle-background-color;
    background-color: @draghandle-background-color;
}
...
.k-filter-menu .k-primary {
    border-left-color: @drop-down-border-color;
}
...
@media only screen and (max-width: 1024px) {
    ...
    .k-safari {
        ...
        .k-pager-numbers .k-current-page .k-link {
            ...
            border-top: 0;
            .box-shadow(0 2px 2px 0 @drop-down-background);
        }

        .k-pager-numbers .k-current-page:hover .k-link {
            border-radius: @border-radius;
            background-color: @widget-background-color;
            border: 1px solid @form-widgets-border-color;
            border-top: 0;
            .box-shadow(@focused-shadow);
        }
        ...
        .k-pager-numbers.k-state-expanded {
            ...
            border-style: solid;
            border-color: @form-widgets-border-color; /*@secondary-border-color*/
            background-color: @widget-background-color;
            border-radius: @border-radius @border-radius 0 0;
            .box-shadow(0 2px 2px 0 @shadow-color);
        }
...
.k-chart .k-handle {
    width: 15px;
    height: 15px;
    background-color: contrast(@background, @selected-text-color, @selected-background, 0.5);
    border-radius: 10px;
}
...
@spreadsheet-pane-border: darken(@background, 20%);
@spreadsheet-cell-border: darken(@background, 10%);

@active-header-text: contrast(@accent);
@inactive-header-text: screen(@accent, #808080);
@header-element-hover: multiply(@accent, #ccc);
...
.k-spreadsheet {
    ...
    .k-spreadsheet-sheets-bar {
        .k-button {
            ...
            &:hover {
                background-color: @header-element-hover;
                border-color: @header-element-hover;
            }
        }
    }
...
.k-toolbar {
    ...
    .k-split-button:focus {
        ...
        .k-split-button-arrow {
            border-left-color: contrast(@button-hover-background-color, lighten(@button-hover-border-color, 6%), darken(@button-hover-border-color, 6%), 0.5);
        }
    }
}

.k-mediaplayer-toolbar {
    background: fade(@drop-down-background, 85%);
}
...
.k-group-start.k-group-end.k-tool {
    border-color: @alt-background-color;
}
