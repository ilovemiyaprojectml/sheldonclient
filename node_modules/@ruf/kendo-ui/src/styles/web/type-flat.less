...
@widget-border-color: darken(@background, 20%);
...
@button-shadow: false;
@button-hover-text-color: @background;
...
@button-focused-border-color: darken(@accent, 11%);
@button-focused-shadow: none;
@button-focused-active-shadow: none;
// Primary button
...
@primary-active-background-color: @base;
@primary-active-border-color: @primary-active-background-color;
@primary-active-gradient: false;
@primary-active-shadow: false;
@primary-focused-border-color: @base;
@primary-focused-shadow: none;
@primary-focused-active-shadow: none;
@primary-disabled-text-color: darken(@background, 24%);
@primary-disabled-background-color: darken(@background, 4%);
@primary-disabled-border-color: darken(@background, 20%);
...
@error-background-color: @background;
@error-border-color: lighten(@base, 4%);
@error-text-color: lighten(@base, 4%);
@disabled-text-color: darken(@background, 24%);
...
@tooltip-border-color: @base;
@tooltip-text-color: @background;
@notification-info-background-color:lighten(@info, 55%);
@notification-info-text-color: @info;
@notification-info-border-color: @info;
@notification-success-background-color: lighten(@success, 52%);
@notification-success-text-color: @success;
@notification-success-border-color: @success;
@notification-warning-background-color: lighten(@warning, 30%);
@notification-warning-text-color: @warning;
@notification-warning-border-color: @warning;
@notification-error-background-color: lighten(@error, 30%);
@notification-error-text-color: @error;
...
@draghandle-shadow: 0 0 0 0;
@draghandle-hover-border-color: @hover-background;
@draghandle-hover-background-color: @hover-background;
@draghandle-hover-shadow: 0 0 0;
@alt-background-color: darken(@background, 4%);
@nested-alt-background-color: darken(@alt-background-color, 8%);
@active-filter-background-color: @accent;
@cell-border-color: darken(@background, 20%);
...
@splitbar-background-color: darken(@background, 20%);
@scheduler-background-color: @background;
@current-time-color: lighten(@base, 4%);
@event-background-color: @hover-background;
@event-text-color: @background;
@event-inverse-text-color: @normal-text-color;
@scheduler-nonwork-background-color: darken(@background, 4%);
@resize-background-color: @background;
@upload-progress-background-color: @info;
@upload-progress-text-color: @widget-text-color;
...
@inner-border-radius: (@border-radius - 1.2);
@slider-border-radius: 13px;
@header-text-color: @background;
@header-background-color: @base;
@focused-border-color: darken(@accent, 11%);
@focused-shadow: none;
@focused-item-shadow: inset 0 0 0 1px darken(@accent, 11%);
@focused-active-item-shadow: inset 0 0 0 1px darken(@accent, 11%);
@calendar-border-radius: 13px;
@calendar-content-text-color: @normal-text-color;
@calendar-footer-background: @base;
@calendar-footer-text-decoration: none;
@calendar-footer-hover-text-decoration: none;
@calendar-footer-hover-background: @hover-background;
@calendar-header-hover-text-decoration: underline;
@calendar-header-hover-background: @base;
@calendar-footer-active-background: @accent;
@calendar-group-background-color: @background;
@menu-border-color: @base;
@tabstrip-items-border: @base;
@tabstrip-active-background: @background;
@tabstrip-tabs-color: @background;
@form-widget-color: @background;
@drop-down-border-color: @accent;
@drop-down-hover-border-color: @hover-background;
@drop-down-focused-border-color: darken(@accent, 11%);
@drop-down-background: @accent;
@drop-down-text-color: @background;
@secondary-border-color: lighten(@base, 18%);
@secondary-text-color: @background;
@numeric-selected-background: @base;
@panelbar-items-border: lighten(@base, 18%);
@panelbar-content-background: @base;
@panelbar-content-color: @background;
@window-shadow-style: 0 0 0 1px;
@filter-menu-content-background: @base;
@icon-background-color: darken(@background, 20%);
@disabled-background-color: darken(@background, 4%);
@disabled-border-color: darken(@background, 20%);
...
.k-separator {
    background-color: fade(@alt-background-color, 10);
}
...
.k-ie .km-pane-wrapper .k-grid .k-pager-wrap {
    color: @header-text-color;
}
...
@checkbox-border-color: @accent;
@checkbox-border-radius: 1px;
@checkbox-hover-border-color: lighten(@hover-background, 8%);
...
.k-chart .k-selection:hover {
    ...
    box-shadow: inset 0 0 0 30px fadeout(@hover-background, 50%);
}
...
@spreadsheet-cell-border: darken(@background, 10%);
@spreadsheet-header-border: lighten(@base, 18%);
@spreadsheet-header-selection-border: darken(@selected-background, 9%);
