...
.k-button-icon {
  height: -webkit-calc(1.72em + 22px);
  height: calc(1.72em + 22px);
}
...
.k-button-icon,
.k-split-button-arrow {
  width: -webkit-calc(1.72em + 22px);
  width: calc(1.72em + 22px);
  padding: 10px 7px;
}
...
.k-ie input.k-textbox {
  height: -webkit-calc(2.564em + 2px);
  height: calc(2.564em + 2px);
}
...
.k-multiselect-wrap li {
  ...
  line-height: 2.064em;
  min-height: -webkit-calc(2.264em + 2px);
  min-height: calc(2.264em + 2px);
  float: left;
  position: relative;
}
