...
@button-focused-shadow: inset 0 0 3px 1px contrast(@base, @hover-border-color, lighten(@hover-border-color, 20%), 0.5);
@button-focused-active-shadow: inset 0 0 3px 1px darken(@selected-border-color, 10%);
// Primary button
@primary-text-color: lighten(@selected-text-color, 12%);
@primary-background-color: lighten(@accent, 7%);
@primary-border-color: contrast(@base, lighten(@accent, 3%), darken(@accent, 3%), 0.5);
...
@primary-focused-border-color: darken(@primary-background-color, 10%);
@primary-focused-shadow: 0 0 3px 0 @accent;
