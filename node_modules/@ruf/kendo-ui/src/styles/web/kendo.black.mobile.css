...
.km-state-active .km-detail {
  -webkit-box-shadow: inset 0 0 0 1000px rgba(77, 77, 77, 0.2);
          box-shadow: inset 0 0 0 1000px rgba(77, 77, 77, 0.2);
}
/* Switch */
.km-switch-wrapper {
...
.km-list > li {
  background: #404040;
  border-color: rgba(255, 255, 255, 0.2);
  -webkit-box-shadow: inset 0 1px 0 rgba(77, 77, 77, 0.2);
          box-shadow: inset 0 1px 0 rgba(77, 77, 77, 0.2);
}
.km-listinset > li:first-child,
.km-listgroupinset .km-list > li:first-child {
  border-color: rgba(255, 255, 255, 0.2);
