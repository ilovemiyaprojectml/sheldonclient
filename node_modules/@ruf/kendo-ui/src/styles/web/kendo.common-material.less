...
.k-split-button-arrow {
    ...
    height: ~"calc(1.28571428em + (2*@{button-padding-y}) + 2px)"; // ensure inline-flex height
    width: ~"calc(1.28571428em + (2*@{button-padding-y}) + 2px)";
}
...
.k-multiselect-wrap li {
    ...
    line-height: calc(@input-height - 0.214em);
    min-height: calc((@input-height + 0.357em) - 6px);
}
...
.k-toolbar {
    ...
    .k-button-icon,
    .k-split-button-arrow {
        height: ~"calc(1.28571428em + (2*@{button-padding-x}) + 2px)"; // ensure inline-flex height
    }

    .k-button-icon {
        width: ~"calc(1.28571428em + (2*@{button-padding-x}) + 2px)";
    }

    & > .k-button:first-child:not(.k-overflow-anchor),
...
.k-colorpicker
{
    ...
    .k-selected-color {
        @selected-icon-height: 2.42857142em;
        height: @selected-icon-height;
        width: @selected-icon-height;
        .k-i-line {
            line-height: @selected-icon-height;
            font-size: @selected-icon-height;
        }
    }
}
...
.k-spreadsheet .k-spreadsheet-action-bar {
    font-size: @spreadsheet-action-bar-font-size;
}
