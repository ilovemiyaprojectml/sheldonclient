@font-face {
  font-family: 'fisfont';
  src:  url('../fonts/fisfont.eot?66nemn');
  src:  url('../fonts/fisfont.eot?66nemn#iefix') format('embedded-opentype'),
    url('../fonts/fisfont.ttf?66nemn') format('truetype'),
    url('../fonts/fisfont.woff?66nemn') format('woff'),
    url('../fonts/fisfont.svg?66nemn#fisfont') format('svg');
  font-weight: normal;
  font-style: normal;
}
