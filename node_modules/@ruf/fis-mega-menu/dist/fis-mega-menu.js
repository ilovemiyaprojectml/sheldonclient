(function () {
    ...
    var __lib_mod_deps = ['shell'];

    angular.module('fis.megamenu', __lib_mod_deps);
})();


'use strict';

angular.module('fis.megamenu')
    .controller('fisMain', ['$scope', function ($scope) {
    }]);
...
angular.module('fis.megamenu').run(['$templateCache', function ($templateCache) {
