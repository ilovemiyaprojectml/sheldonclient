...
function flipValueOf(prop, value) {
  ...
  normalizedProperty = RE_PREFIX.test(normalizedProperty)
    ? normalizedProperty.split(RE_PREFIX)[1]
    : normalizedProperty;

  var flipFn = Object.prototype.hasOwnProperty.call(VALUES, normalizedProperty)
    ? VALUES[normalizedProperty]
    : false;
...
module.exports.flipValueOf = flipValueOf;
module.exports.FLIPVALUES = VALUES;
